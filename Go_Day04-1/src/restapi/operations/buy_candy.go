...
// BuyCandyUnauthorizedBody buy candy unauthorized body
//
// swagger:model BuyCandyUnauthorizedBody
type BuyCandyUnauthorizedBody struct {

	// error
	Error string `json:"error,omitempty"`
}

// Validate validates this buy candy unauthorized body
func (o *BuyCandyUnauthorizedBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this buy candy unauthorized body based on context it is used
func (o *BuyCandyUnauthorizedBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *BuyCandyUnauthorizedBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
	return swag.WriteJSON(o)
...
// UnmarshalBinary interface implementation
func (o *BuyCandyUnauthorizedBody) UnmarshalBinary(b []byte) error {
	var res BuyCandyUnauthorizedBody
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*o = res
